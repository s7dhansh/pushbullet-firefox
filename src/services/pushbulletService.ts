...
export const fetchSMSThreads = async (apiKey: string, userIden: string, deviceIden: string): Promise<any> => {
	const payload = {
		type: 'push',
		push: {
...
export const fetchThreadMessages = async (apiKey: string, userIden: string, deviceIden: string, threadId: string): Promise<any> => {
	const payload = {
		type: 'push',
		push: {
