...
export const sendSMS = async (
  ...
  // SMS in Pushbullet is done via ephemeral messages targeting the phone
  const payload = {
    push: {
      type: 'messaging_extension_reply',
      package_name: 'com.pushbullet.android',
      source_user_iden: 'target_user_iden_placeholder', // Usually handled by server, but for ephemeral sending to own device this structure is specific
